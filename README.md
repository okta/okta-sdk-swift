...
We also publish these other libraries for Swift:
 
* [Okta OIDC SDK](https://github.com/okta/okta-oidc-ios)
* [Okta IDX Authentication SDK](https://github.com/okta/okta-idx-swift)
 
You can learn more on the [Okta + Swift][lang-landing] page in our documentation.
...
These examples will help you understand how to use this library. You can also browse the full [API reference documentation][swiftdocs].
...
[swiftdocs]: https://developer.okta.com/okta-sdk-swift/latest/
