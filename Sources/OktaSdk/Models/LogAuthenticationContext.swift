...
public final class LogAuthenticationContext: Codable, Hashable {
    ...
    public static func == (lhs: LogAuthenticationContext, rhs: LogAuthenticationContext) -> Bool {
        lhs.authenticationProvider == rhs.authenticationProvider &&
        lhs.authenticationStep == rhs.authenticationStep &&
        lhs.credentialProvider == rhs.credentialProvider &&
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(authenticationProvider?.hashValue)
        hasher.combine(authenticationStep?.hashValue)
        hasher.combine(credentialProvider?.hashValue)
        hasher.combine(credentialType?.hashValue)
        hasher.combine(externalSessionId?.hashValue)
