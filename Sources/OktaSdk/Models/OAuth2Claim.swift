...
public final class OAuth2Claim: Codable, Hashable {
    ...
    public static func == (lhs: OAuth2Claim, rhs: OAuth2Claim) -> Bool {
        lhs.links == rhs.links &&
        lhs.alwaysIncludeInToken == rhs.alwaysIncludeInToken &&
        lhs.claimType == rhs.claimType &&
        lhs.conditions == rhs.conditions &&
        lhs.groupFilterType == rhs.groupFilterType &&
        lhs.id == rhs.id &&
        lhs.name == rhs.name &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(alwaysIncludeInToken?.hashValue)
        hasher.combine(claimType?.hashValue)
        hasher.combine(conditions?.hashValue)
        hasher.combine(groupFilterType?.hashValue)
