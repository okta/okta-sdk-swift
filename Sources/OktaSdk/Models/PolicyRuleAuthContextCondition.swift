...
public final class PolicyRuleAuthContextCondition: Codable, Hashable {
    ...
    public static func == (lhs: PolicyRuleAuthContextCondition, rhs: PolicyRuleAuthContextCondition) -> Bool {
