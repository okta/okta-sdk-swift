...
public final class ModelProtocol: Codable, Hashable {
    ...
    public static func == (lhs: ModelProtocol, rhs: ModelProtocol) -> Bool {
        lhs.algorithms == rhs.algorithms &&
        lhs.credentials == rhs.credentials &&
        lhs.endpoints == rhs.endpoints &&
        lhs.issuer == rhs.issuer &&
        lhs.relayState == rhs.relayState &&
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(algorithms?.hashValue)
        hasher.combine(credentials?.hashValue)
        hasher.combine(endpoints?.hashValue)
        hasher.combine(issuer?.hashValue)
        hasher.combine(relayState?.hashValue)
