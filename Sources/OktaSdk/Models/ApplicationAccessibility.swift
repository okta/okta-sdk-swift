...
public final class ApplicationAccessibility: Codable, Hashable {
    ...
    public static func == (lhs: ApplicationAccessibility, rhs: ApplicationAccessibility) -> Bool {
        lhs.errorRedirectUrl == rhs.errorRedirectUrl &&
        lhs.loginRedirectUrl == rhs.loginRedirectUrl &&
        lhs.selfService == rhs.selfService
        
    }

    public func hash(into hasher: inout Hasher) {
        hasher.combine(errorRedirectUrl?.hashValue)
        hasher.combine(loginRedirectUrl?.hashValue)
        hasher.combine(selfService?.hashValue)
