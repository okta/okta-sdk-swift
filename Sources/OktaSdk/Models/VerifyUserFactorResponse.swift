...
public final class VerifyUserFactorResponse: Codable, Hashable {
    ...
    public static func == (lhs: VerifyUserFactorResponse, rhs: VerifyUserFactorResponse) -> Bool {
        lhs.embedded == rhs.embedded &&
        lhs.links == rhs.links &&
        lhs.expiresAt == rhs.expiresAt &&
        lhs.factorResult == rhs.factorResult &&
        lhs.factorResultMessage == rhs.factorResultMessage
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(factorResult?.hashValue)
        hasher.combine(factorResultMessage?.hashValue)
