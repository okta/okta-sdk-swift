...
public final class JsonWebKey: Codable, Hashable {
    ...
    public static func == (lhs: JsonWebKey, rhs: JsonWebKey) -> Bool {
        lhs.links == rhs.links &&
        lhs.alg == rhs.alg &&
        lhs.created == rhs.created &&
        lhs.e == rhs.e &&
        lhs.expiresAt == rhs.expiresAt &&
        lhs.keyOps == rhs.keyOps &&
        lhs.kid == rhs.kid &&
        lhs.kty == rhs.kty &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(alg?.hashValue)
        hasher.combine(created?.hashValue)
        hasher.combine(e?.hashValue)
        hasher.combine(expiresAt?.hashValue)
        hasher.combine(keyOps?.hashValue)
        ...
        hasher.combine(x5c?.hashValue)
        hasher.combine(x5t?.hashValue)
        hasher.combine(x5tS256?.hashValue)
        hasher.combine(x5u?.hashValue)
