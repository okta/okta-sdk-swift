...
public final class AppInstancePolicyRuleCondition: Codable, Hashable {
    ...
    public static func == (lhs: AppInstancePolicyRuleCondition, rhs: AppInstancePolicyRuleCondition) -> Bool {
