//
// GroupPolicyRuleCondition.swift
//
...
public final class GroupPolicyRuleCondition: Codable, Hashable {
    ...
    public static func == (lhs: GroupPolicyRuleCondition, rhs: GroupPolicyRuleCondition) -> Bool {
