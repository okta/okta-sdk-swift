...
public final class AuthorizationServerCredentialsSigningConfig: Codable, Hashable {
    ...
    public static func == (lhs: AuthorizationServerCredentialsSigningConfig, rhs: AuthorizationServerCredentialsSigningConfig) -> Bool {
        lhs.kid == rhs.kid &&
