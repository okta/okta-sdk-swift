...
public final class AuthorizationServerPolicyRule: Codable, Hashable {
    ...
    public static func == (lhs: AuthorizationServerPolicyRule, rhs: AuthorizationServerPolicyRule) -> Bool {
