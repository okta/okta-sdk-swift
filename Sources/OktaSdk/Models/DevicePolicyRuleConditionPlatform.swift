...
public final class DevicePolicyRuleConditionPlatform: Codable, Hashable {
    ...
    public static func == (lhs: DevicePolicyRuleConditionPlatform, rhs: DevicePolicyRuleConditionPlatform) -> Bool {
        lhs.supportedMDMFrameworks == rhs.supportedMDMFrameworks &&
        lhs.types == rhs.types
        
    }

    public func hash(into hasher: inout Hasher) {
        hasher.combine(supportedMDMFrameworks?.hashValue)
        hasher.combine(types?.hashValue)
