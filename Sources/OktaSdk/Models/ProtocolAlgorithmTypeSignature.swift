...
public final class ProtocolAlgorithmTypeSignature: Codable, Hashable {
    ...
    public static func == (lhs: ProtocolAlgorithmTypeSignature, rhs: ProtocolAlgorithmTypeSignature) -> Bool {
