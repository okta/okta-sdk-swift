...
public final class CatalogApplication: Codable, Hashable {
    ...
    public static func == (lhs: CatalogApplication, rhs: CatalogApplication) -> Bool {
        lhs.id == rhs.id &&
        lhs.name == rhs.name &&
        ...
        lhs.signOnModes == rhs.signOnModes &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(signOnModes?.hashValue)
