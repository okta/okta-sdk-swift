...
public final class IdentityProviderApplicationUser: Codable, Hashable {
    ...
    public static func == (lhs: IdentityProviderApplicationUser, rhs: IdentityProviderApplicationUser) -> Bool {
