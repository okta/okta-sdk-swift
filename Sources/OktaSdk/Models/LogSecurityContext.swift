...
public final class LogSecurityContext: Codable, Hashable {
    ...
    public static func == (lhs: LogSecurityContext, rhs: LogSecurityContext) -> Bool {
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(asNumber?.hashValue)
        hasher.combine(asOrg?.hashValue)
        hasher.combine(domain?.hashValue)
        hasher.combine(isProxy?.hashValue)
        hasher.combine(isp?.hashValue)
