...
public final class GroupRuleUserCondition: Codable, Hashable {
    ...
    public static func == (lhs: GroupRuleUserCondition, rhs: GroupRuleUserCondition) -> Bool {
