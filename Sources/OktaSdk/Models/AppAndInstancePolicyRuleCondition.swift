...
public final class AppAndInstancePolicyRuleCondition: Codable, Hashable {
    ...
    public static func == (lhs: AppAndInstancePolicyRuleCondition, rhs: AppAndInstancePolicyRuleCondition) -> Bool {
