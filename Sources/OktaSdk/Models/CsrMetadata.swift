...
public final class CsrMetadata: Codable, Hashable {
    ...
    public static func == (lhs: CsrMetadata, rhs: CsrMetadata) -> Bool {
        lhs.subject == rhs.subject &&
        lhs.subjectAltNames == rhs.subjectAltNames
        
    }

    public func hash(into hasher: inout Hasher) {
        hasher.combine(subject?.hashValue)
        hasher.combine(subjectAltNames?.hashValue)
