...
public final class PolicyRuleConditions: Codable, Hashable {
    ...
    public static func == (lhs: PolicyRuleConditions, rhs: PolicyRuleConditions) -> Bool {
        lhs.app == rhs.app &&
        lhs.apps == rhs.apps &&
        lhs.authContext == rhs.authContext &&
        lhs.authProvider == rhs.authProvider &&
        lhs.beforeScheduledAction == rhs.beforeScheduledAction &&
        ...
        lhs.mdmEnrollment == rhs.mdmEnrollment &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(apps?.hashValue)
        hasher.combine(authContext?.hashValue)
        hasher.combine(authProvider?.hashValue)
        hasher.combine(beforeScheduledAction?.hashValue)
        ...
        hasher.combine(identityProvider?.hashValue)
        hasher.combine(mdmEnrollment?.hashValue)
        hasher.combine(network?.hashValue)
        hasher.combine(people?.hashValue)
        hasher.combine(platform?.hashValue)
        hasher.combine(risk?.hashValue)
        hasher.combine(riskScore?.hashValue)
        hasher.combine(scopes?.hashValue)
        hasher.combine(userIdentifier?.hashValue)
