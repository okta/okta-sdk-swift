...
public final class OktaSignOnPolicyRuleSignonActions: Codable, Hashable {
    ...
    public static func == (lhs: OktaSignOnPolicyRuleSignonActions, rhs: OktaSignOnPolicyRuleSignonActions) -> Bool {
        lhs.access == rhs.access &&
        lhs.factorLifetime == rhs.factorLifetime &&
        lhs.factorPromptMode == rhs.factorPromptMode &&
        lhs.rememberDeviceByDefault == rhs.rememberDeviceByDefault &&
        lhs.requireFactor == rhs.requireFactor &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(factorLifetime?.hashValue)
        hasher.combine(factorPromptMode?.hashValue)
        hasher.combine(rememberDeviceByDefault?.hashValue)
        hasher.combine(requireFactor?.hashValue)
