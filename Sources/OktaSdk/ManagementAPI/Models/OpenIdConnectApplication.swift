...
public struct OpenIdConnectApplication: Codable, Hashable {
    ...
    public init(accessibility: ApplicationAccessibility? = nil, created: Date? = nil, features: [String]? = nil, id: String? = nil, label: String? = nil, lastUpdated: Date? = nil, licensing: ApplicationLicensing? = nil, profile: [String: AnyCodable]? = nil, signOnMode: ApplicationSignOnMode? = nil, status: ApplicationLifecycleStatus? = nil, visibility: ApplicationVisibility? = nil, embedded: [String: AnyCodable]? = nil, links: [String: AnyCodable]? = nil, credentials: OAuthApplicationCredentials? = nil, name: String? = "oidc_client", settings: OpenIdConnectApplicationSettings? = nil) {
