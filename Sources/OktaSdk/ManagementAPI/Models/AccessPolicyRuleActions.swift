...
public struct AccessPolicyRuleActions: Codable, Hashable {
    ...
    public var appSignOn: AccessPolicyRuleApplicationSignOn?

    public init(enroll: PolicyRuleActionsEnroll? = nil, idp: IdpPolicyRuleAction? = nil, passwordChange: PasswordPolicyRuleAction? = nil, selfServicePasswordReset: PasswordPolicyRuleAction? = nil, selfServiceUnlock: PasswordPolicyRuleAction? = nil, signon: OktaSignOnPolicyRuleSignonActions? = nil, appSignOn: AccessPolicyRuleApplicationSignOn? = nil) {
        self.enroll = enroll
        self.idp = idp
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(appSignOn, forKey: .appSignOn)
    }
