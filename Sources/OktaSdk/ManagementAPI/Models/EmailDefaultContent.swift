...
public struct EmailDefaultContent: Codable, Hashable {
    ...
    public var links: EmailDefaultContentAllOfLinks?

    public init(body: String, subject: String, links: EmailDefaultContentAllOfLinks? = nil) {
        self.body = body
