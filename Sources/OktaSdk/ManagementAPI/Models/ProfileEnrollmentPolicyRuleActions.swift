...
public struct ProfileEnrollmentPolicyRuleActions: Codable, Hashable {
    ...
    public var profileEnrollment: ProfileEnrollmentPolicyRuleAction?

    public init(enroll: PolicyRuleActionsEnroll? = nil, idp: IdpPolicyRuleAction? = nil, passwordChange: PasswordPolicyRuleAction? = nil, selfServicePasswordReset: PasswordPolicyRuleAction? = nil, selfServiceUnlock: PasswordPolicyRuleAction? = nil, signon: OktaSignOnPolicyRuleSignonActions? = nil, profileEnrollment: ProfileEnrollmentPolicyRuleAction? = nil) {
        self.enroll = enroll
        self.idp = idp
        ...
        self.signon = signon
        self.profileEnrollment = profileEnrollment
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(profileEnrollment, forKey: .profileEnrollment)
    }
