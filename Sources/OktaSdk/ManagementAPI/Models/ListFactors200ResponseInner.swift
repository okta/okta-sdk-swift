...
public struct ListFactors200ResponseInner: Codable, Hashable {
    ...
    public init(created: Date? = nil, factorType: FactorType? = nil, id: String? = nil, lastUpdated: Date? = nil, provider: FactorProvider? = nil, status: FactorStatus? = nil, verify: VerifyFactorRequest? = nil, embedded: [String: AnyCodable]? = nil, links: [String: AnyCodable]? = nil, profile: WebAuthnUserFactorProfile? = nil, expiresAt: Date? = nil, factorResult: FactorResultType? = nil, factorProfileId: String? = nil) {
