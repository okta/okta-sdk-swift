...
public struct Theme: Codable, Hashable {
    ...
    public init(backgroundImage: String? = nil, emailTemplateTouchPointVariant: EmailTemplateTouchPointVariant? = nil, endUserDashboardTouchPointVariant: EndUserDashboardTouchPointVariant? = nil, errorPageTouchPointVariant: ErrorPageTouchPointVariant? = nil, primaryColorContrastHex: String? = nil, primaryColorHex: String? = nil, secondaryColorContrastHex: String? = nil, secondaryColorHex: String? = nil, signInPageTouchPointVariant: SignInPageTouchPointVariant? = nil, links: [String: AnyCodable]? = nil) {
