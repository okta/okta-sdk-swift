...
public struct IdentityProviderPolicyAllOf: Codable, Hashable {
    ...
    public init(accountLink: PolicyAccountLink? = nil, conditions: PolicyRuleConditions? = nil, maxClockSkew: Int? = nil, provisioning: Provisioning? = nil, subject: PolicySubject? = nil) {
