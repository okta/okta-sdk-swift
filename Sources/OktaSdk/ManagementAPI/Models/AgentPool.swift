...
public struct AgentPool: Codable, Hashable {
    ...
    public init(agents: [Agent]? = nil, id: String? = nil, name: String? = nil, operationalStatus: OperationalStatus? = nil, type: AgentType? = nil) {
        self.agents = agents
        self.id = id
        self.name = name
