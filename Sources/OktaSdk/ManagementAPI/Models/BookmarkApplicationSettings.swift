...
public struct BookmarkApplicationSettings: Codable, Hashable {
    ...
    public init(identityStoreId: String? = nil, implicitAssignment: Bool? = nil, inlineHookId: String? = nil, notes: ApplicationSettingsNotes? = nil, notifications: ApplicationSettingsNotifications? = nil, app: BookmarkApplicationSettingsApplication? = nil) {
