...
public struct EmailCustomizationAllOf: Codable, Hashable {
    ...
    public init(created: Date? = nil, id: String? = nil, isDefault: Bool? = nil, language: String, lastUpdated: Date? = nil, links: EmailCustomizationAllOfLinks? = nil) {
