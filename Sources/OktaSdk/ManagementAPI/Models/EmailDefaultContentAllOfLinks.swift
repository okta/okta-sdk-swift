...
public struct EmailDefaultContentAllOfLinks: Codable, Hashable {

    public var _self: HrefObject?
    public var template: HrefObject?
    public var preview: HrefObject?
    public var test: HrefObject?

    public init(_self: HrefObject? = nil, template: HrefObject? = nil, preview: HrefObject? = nil, test: HrefObject? = nil) {
        self._self = _self
