...
public struct AccessPolicyRuleConditions: Codable, Hashable {
    ...
    public init(app: AppAndInstancePolicyRuleCondition? = nil, apps: AppInstancePolicyRuleCondition? = nil, authContext: PolicyRuleAuthContextCondition? = nil, authProvider: PasswordPolicyAuthenticationProviderCondition? = nil, beforeScheduledAction: BeforeScheduledActionPolicyRuleCondition? = nil, clients: ClientPolicyCondition? = nil, context: ContextPolicyRuleCondition? = nil, device: DeviceAccessPolicyRuleCondition? = nil, grantTypes: GrantTypePolicyRuleCondition? = nil, groups: GroupPolicyRuleCondition? = nil, identityProvider: IdentityProviderPolicyRuleCondition? = nil, mdmEnrollment: MDMEnrollmentPolicyRuleCondition? = nil, network: PolicyNetworkCondition? = nil, people: PolicyPeopleCondition? = nil, platform: PlatformPolicyRuleCondition? = nil, risk: RiskPolicyRuleCondition? = nil, riskScore: RiskScorePolicyRuleCondition? = nil, scopes: OAuth2ScopesMediationPolicyRuleCondition? = nil, userIdentifier: UserIdentifierPolicyRuleCondition? = nil, users: UserPolicyRuleCondition? = nil, userStatus: UserStatusPolicyRuleCondition? = nil, elCondition: AccessPolicyRuleCustomCondition? = nil, userType: UserTypeCondition? = nil) {
        self.app = app
        self.apps = apps
