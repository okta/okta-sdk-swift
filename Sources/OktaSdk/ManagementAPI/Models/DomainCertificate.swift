...
public struct DomainCertificate: Codable, Hashable {

    public var certificate: String?
    public var certificateChain: String?
    public var privateKey: String?
    public var type: DomainCertificateType?

    public init(certificate: String? = nil, certificateChain: String? = nil, privateKey: String? = nil, type: DomainCertificateType? = nil) {
