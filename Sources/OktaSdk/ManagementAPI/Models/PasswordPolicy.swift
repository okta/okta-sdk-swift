...
public struct PasswordPolicy: Codable, Hashable {
    ...
    public init(created: Date? = nil, description: String? = nil, id: String? = nil, lastUpdated: Date? = nil, name: String? = nil, priority: Int? = nil, status: LifecycleStatus? = nil, system: Bool? = nil, type: PolicyType? = nil, embedded: [String: AnyCodable]? = nil, links: [String: AnyCodable]? = nil, conditions: PasswordPolicyConditions? = nil, settings: PasswordPolicySettings? = nil) {
