...
public struct DeviceAccessPolicyRuleCondition: Codable, Hashable {
    ...
    public init(migrated: Bool? = nil, platform: DevicePolicyRuleConditionPlatform? = nil, rooted: Bool? = nil, trustLevel: DevicePolicyTrustLevel? = nil, managed: Bool? = nil, registered: Bool? = nil) {
