...
public struct AuthorizationServerPolicyRuleActions: Codable, Hashable {
    ...
    public init(enroll: PolicyRuleActionsEnroll? = nil, idp: IdpPolicyRuleAction? = nil, passwordChange: PasswordPolicyRuleAction? = nil, selfServicePasswordReset: PasswordPolicyRuleAction? = nil, selfServiceUnlock: PasswordPolicyRuleAction? = nil, signon: OktaSignOnPolicyRuleSignonActions? = nil, token: TokenAuthorizationServerPolicyRuleAction? = nil) {
        self.enroll = enroll
        self.idp = idp
