...
public struct PossessionConstraintAllOf: Codable, Hashable {
    ...
    public init(deviceBound: String? = nil, hardwareProtection: String? = nil, phishingResistant: String? = nil, userPresence: String? = nil) {
